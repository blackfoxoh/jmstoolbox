...
public class ColumnsSetDialog extends Dialog {
   ...
   protected Control createDialogArea(Composite parent) {
      ...
      label2.setText("Property/Map Key Name: ");
      ...
      newUserPropertyName.setToolTipText("Name of the JMS Message property or the name of the key in the Map Message");
